//
//  ConSub2ViewModel.swift
//  Calmscient
//
//  State and navigation for Alcohol-related mental dysfunction (parity with `ConSub2VC`).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
@MainActor
final class ConSub2ViewModel: ObservableObject {

    weak var hostViewController: UIViewController?

    @Published private(set) var content = ConSub2ContentPresentation(
        headerTitle: "",
        introText: "",
        numberedItems: []
    )
    ...
    func reloadLocalizedStrings() {
        ...
        content = ConSub2Presentation.buildLocalizedContent()
    }
...
enum ConSub2Navigation {
    ...
    static func push(
        ...
        let consequenceSubHost = ConSub2HostingController()
