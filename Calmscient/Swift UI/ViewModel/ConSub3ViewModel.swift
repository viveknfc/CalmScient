//
//  ConSub3ViewModel.swift
//  Calmscient
//
//  State and navigation for Alcohol-related blackouts (parity with `ConSub3VC`).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
@MainActor
final class ConSub3ViewModel: ObservableObject {

    weak var hostViewController: UIViewController?

    @Published private(set) var content = ConSub3ContentPresentation(
        headerTitle: "",
        bodyText: ""
    )
    ...
    func reloadLocalizedStrings() {
        ...
        content = ConSub3Presentation.buildLocalizedContent()
    }
...
enum ConSub3Navigation {
    ...
    static func push(
        ...
        let consequenceSubHost = ConSub3HostingController()
