//
//  TryingToQuitViewModel.swift
//  Calmscient
//
//  State and navigation for trying-to-quit (parity with `TryingToQuitVC`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
@MainActor
final class TryingToQuitViewModel: ObservableObject {

    weak var hostViewController: UIViewController?

    @Published private(set) var content = TryingToQuitContentPresentation(
        headerTitle: "",
        introParagraphs: [],
        habitsSectionTitle: "",
        habitBulletItems: [],
    ...
    func reloadLocalizedStrings() {
        ...
        content = TryingToQuitPresentation.buildLocalizedContent()
    }
...
enum TryingToQuitNavigation {
    ...
    static func push(
        ...
        let tryingHost = TryingToQuitHostingController()
        tryingHost.viewModel.configure(navigationTitle: navigationTitle)
        nav.pushViewController(tryingHost, animated: animated)
    }
}
