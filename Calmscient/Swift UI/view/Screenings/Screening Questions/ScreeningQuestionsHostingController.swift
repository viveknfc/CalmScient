//
//  ScreeningQuestionsHostingController.swift
//  Calmscient
//
//  UIKit shell for `ScreeningQuestionsView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  15 May 2026
//
...
@available(iOS 16.0, *)
final class ScreeningQuestionsHostingController: UIViewController {

    let viewModel = ScreeningQuestionsViewModel()
    private var hostingController: UIHostingController<ScreeningQuestionsView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ScreeningQuestionsView(viewModel: viewModel))
    ...
    private func applyNavigationChrome() {
        ...
        viewModel.refreshNavigationChrome()
    }
}
