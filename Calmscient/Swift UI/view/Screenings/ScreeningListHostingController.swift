//
//  ScreeningListHostingController.swift
//  Calmscient
//
//  UIKit shell for `ScreeningListView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  15 May 2026
//
...
@available(iOS 16.0, *)
final class ScreeningListHostingController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ScreeningListView(viewModel: viewModel))
