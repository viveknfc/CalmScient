//
//  ProgressOnCourseWorkHostingController.swift
//  Calmscient
//
//  UIKit shell for `ProgressOnCourseWorkView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  18 May 2026
//
...
@available(iOS 16.0, *)
final class ProgressOnCourseWorkHostingController: UIViewController {

    let viewModel = ProgressOnCourseWorkViewModel()
    private var hostingController: UIHostingController<ProgressOnCourseWorkView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ProgressOnCourseWorkView(viewModel: viewModel))
