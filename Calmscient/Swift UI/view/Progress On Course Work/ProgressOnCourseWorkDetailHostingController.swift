//
//  ProgressOnCourseWorkDetailHostingController.swift
//  Calmscient
//
//  UIKit shell for `ProgressOnCourseWorkDetailView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  18 May 2026
//
...
@available(iOS 16.0, *)
final class ProgressOnCourseWorkDetailHostingController: UIViewController {

    let viewModel = ProgressOnCourseWorkDetailViewModel()
    private var hostingController: UIHostingController<ProgressOnCourseWorkDetailView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ProgressOnCourseWorkDetailView(viewModel: viewModel))
