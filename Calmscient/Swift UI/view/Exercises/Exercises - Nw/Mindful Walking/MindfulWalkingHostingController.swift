//
//  MindfulWalkingHostingController.swift
//  Calmscient
//
//  UIKit shell for `MindfulWalkingView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class MindfulWalkingHostingController: UIViewController {

    private let viewModel = MindfulWalkingViewModel()
    private var hostingController: UIHostingController<MindfulWalkingView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: MindfulWalkingView(viewModel: viewModel))
