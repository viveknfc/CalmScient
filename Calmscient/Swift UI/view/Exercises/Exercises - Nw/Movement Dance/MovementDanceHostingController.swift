//
//  MovementDanceHostingController.swift
//  Calmscient
//
//  UIKit shell for `MovementDanceView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class MovementDanceHostingController: UIViewController {

    private let viewModel = MovementDanceViewModel()
    private var hostingController: UIHostingController<MovementDanceView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: MovementDanceView(viewModel: viewModel))
