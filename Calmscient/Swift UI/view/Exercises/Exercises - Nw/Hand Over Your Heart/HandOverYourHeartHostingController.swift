//
//  HandOverYourHeartHostingController.swift
//  Calmscient
//
//  UIKit shell for `HandOverYourHeartView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class HandOverYourHeartHostingController: UIViewController {

    private let viewModel = HandOverYourHeartViewModel()
    private var hostingController: UIHostingController<HandOverYourHeartView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: HandOverYourHeartView(viewModel: viewModel))
