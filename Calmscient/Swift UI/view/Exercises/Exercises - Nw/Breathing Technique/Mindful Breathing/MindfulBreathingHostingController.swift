//
//  MindfulBreathingHostingController.swift
//  Calmscient
//
//  UIKit shell for `MindfulBreathingView` (navigation, `NavigationBack`).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class MindfulBreathingHostingController: UIViewController {

    private let viewModel = MindfulBreathingViewModel()
    private var hostingController: UIHostingController<MindfulBreathingView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: MindfulBreathingView(viewModel: viewModel))
