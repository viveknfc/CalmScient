//
//  BreathingTechniqueType1HostingController.swift
//  Calmscient
//
//  UIKit shell for `BreathingTechniqueType1View` (navigation, `NavigationBack`).
//
//  Vivek
//  20 May 2026
//
...
@available(iOS 16.0, *)
final class BreathingTechniqueType1HostingController: UIViewController {

    private let viewModel = BreathingTechniqueType1ViewModel()
    private var hostingController: UIHostingController<BreathingTechniqueType1View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: BreathingTechniqueType1View(viewModel: viewModel))
