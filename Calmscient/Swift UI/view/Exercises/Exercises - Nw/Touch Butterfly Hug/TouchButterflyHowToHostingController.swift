//
//  TouchButterflyHowToHostingController.swift
//  Calmscient
//
//  UIKit shell for `TouchButterflyHowToView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class TouchButterflyHowToHostingController: UIViewController {

    private let viewModel = TouchButterflyHugViewModel()
    private var hostingController: UIHostingController<TouchButterflyHowToView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: TouchButterflyHowToView(viewModel: viewModel))
