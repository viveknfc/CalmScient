//
//  TouchButterflyIntroHostingController.swift
//  Calmscient
//
//  UIKit shell for `TouchButterflyIntroView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class TouchButterflyIntroHostingController: UIViewController {

    private let viewModel = TouchButterflyHugViewModel()
    private var hostingController: UIHostingController<TouchButterflyIntroView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: TouchButterflyIntroView(viewModel: viewModel))
