//
//  MovementRunningHostingController.swift
//  Calmscient
//
//  UIKit shell for `MovementRunningView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class MovementRunningHostingController: UIViewController {

    private let viewModel = MovementRunningViewModel()
    private var hostingController: UIHostingController<MovementRunningView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: MovementRunningView(viewModel: viewModel))
