//
//  ProgressiveHostingController.swift
//  Calmscient
//
//  UIKit shell for `ProgressiveView` (navigation, `NavigationBack`).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class ProgressiveHostingController: UIViewController {

    private let viewModel = ProgressiveViewModel()
    private var hostingController: UIHostingController<ProgressiveView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ProgressiveView(viewModel: viewModel))
