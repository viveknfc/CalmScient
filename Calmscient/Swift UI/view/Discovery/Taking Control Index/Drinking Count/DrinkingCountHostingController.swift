//
//  DrinkingCountHostingController.swift
//  Calmscient
//
//  UIKit shell for `DrinkingCountView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class DrinkingCountHostingController: UIViewController {

    private let viewModel = DrinkingCountViewModel()
    private var hostingController: UIHostingController<DrinkingCountView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: DrinkingCountView(viewModel: viewModel))
