//
//  MySmokingHabitHostingController.swift
//  Calmscient
//
//  UIKit shell for `MySmokingHabitView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class MySmokingHabitHostingController: UIViewController {

    let viewModel = MySmokingHabitViewModel()
    private var hostingController: UIHostingController<MySmokingHabitView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: MySmokingHabitView(viewModel: viewModel))
