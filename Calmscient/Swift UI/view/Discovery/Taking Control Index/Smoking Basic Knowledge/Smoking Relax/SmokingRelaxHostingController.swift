//
//  SmokingRelaxHostingController.swift
//  Calmscient
//
//  UIKit shell for `SmokingRelaxView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class SmokingRelaxHostingController: UIViewController {

    let viewModel = SmokingRelaxViewModel()
    private var hostingController: UIHostingController<SmokingRelaxView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: SmokingRelaxView(viewModel: viewModel))
