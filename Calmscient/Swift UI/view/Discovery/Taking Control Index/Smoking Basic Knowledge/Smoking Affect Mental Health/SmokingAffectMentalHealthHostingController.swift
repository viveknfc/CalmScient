//
//  SmokingAffectMentalHealthHostingController.swift
//  Calmscient
//
//  UIKit shell for `SmokingAffectMentalHealthView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class SmokingAffectMentalHealthHostingController: UIViewController {

    let viewModel = SmokingAffectMentalHealthViewModel()
    private var hostingController: UIHostingController<SmokingAffectMentalHealthView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: SmokingAffectMentalHealthView(viewModel: viewModel))
