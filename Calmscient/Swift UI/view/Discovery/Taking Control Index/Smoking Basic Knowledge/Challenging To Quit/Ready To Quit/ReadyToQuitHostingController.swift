//
//  ReadyToQuitHostingController.swift
//  Calmscient
//
//  UIKit shell for `ReadyToQuitView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class ReadyToQuitHostingController: UIViewController {

    let viewModel = ReadyToQuitViewModel()
    private var hostingController: UIHostingController<ReadyToQuitView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ReadyToQuitView(viewModel: viewModel))
