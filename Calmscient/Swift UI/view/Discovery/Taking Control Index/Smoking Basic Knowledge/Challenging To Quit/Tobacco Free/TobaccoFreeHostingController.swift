//
//  TobaccoFreeHostingController.swift
//  Calmscient
//
//  UIKit shell for `TobaccoFreeView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class TobaccoFreeHostingController: UIViewController {

    let viewModel = TobaccoFreeViewModel()
    private var hostingController: UIHostingController<TobaccoFreeView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: TobaccoFreeView(viewModel: viewModel))
