//
//  ChallengingToQuitHostingController.swift
//  Calmscient
//
//  UIKit shell for `ChallengingToQuitView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class ChallengingToQuitHostingController: UIViewController {

    let viewModel = ChallengingToQuitViewModel()
    private var hostingController: UIHostingController<ChallengingToQuitView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ChallengingToQuitView(viewModel: viewModel))
