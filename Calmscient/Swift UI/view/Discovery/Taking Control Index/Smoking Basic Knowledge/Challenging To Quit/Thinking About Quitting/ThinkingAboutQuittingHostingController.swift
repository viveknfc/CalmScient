//
//  ThinkingAboutQuittingHostingController.swift
//  Calmscient
//
//  UIKit shell for `ThinkingAboutQuittingView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class ThinkingAboutQuittingHostingController: UIViewController {

    let viewModel = ThinkingAboutQuittingViewModel()
    private var hostingController: UIHostingController<ThinkingAboutQuittingView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ThinkingAboutQuittingView(viewModel: viewModel))
