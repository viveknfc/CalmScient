//
//  TryingToQuitHostingController.swift
//  Calmscient
//
//  UIKit shell for `TryingToQuitView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class TryingToQuitHostingController: UIViewController {

    let viewModel = TryingToQuitViewModel()
    private var hostingController: UIHostingController<TryingToQuitView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: TryingToQuitView(viewModel: viewModel))
