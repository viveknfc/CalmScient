//
//  VapingHostingController.swift
//  Calmscient
//
//  UIKit shell for `VapingView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class VapingHostingController: UIViewController {

    let viewModel = VapingViewModel()
    private var hostingController: UIHostingController<VapingView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: VapingView(viewModel: viewModel))
