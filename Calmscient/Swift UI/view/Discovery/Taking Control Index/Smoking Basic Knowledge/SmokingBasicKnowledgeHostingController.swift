//
//  SmokingBasicKnowledgeHostingController.swift
//  Calmscient
//
//  UIKit shell for `SmokingBasicKnowledgeView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class SmokingBasicKnowledgeHostingController: UIViewController {

    private let viewModel = SmokingBasicKnowledgeViewModel()
    private var hostingController: UIHostingController<SmokingBasicKnowledgeView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: SmokingBasicKnowledgeView(viewModel: viewModel))
