//
//  TobaccoHostingController.swift
//  Calmscient
//
//  UIKit shell for `TobaccoView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  26 May 2026
//
...
@available(iOS 16.0, *)
final class TobaccoHostingController: UIViewController {

    let viewModel = TobaccoViewModel()
    private var hostingController: UIHostingController<TobaccoView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: TobaccoView(viewModel: viewModel))
