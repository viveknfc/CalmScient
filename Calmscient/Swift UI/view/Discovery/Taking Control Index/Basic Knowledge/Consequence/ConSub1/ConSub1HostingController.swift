//
//  ConSub1HostingController.swift
//  Calmscient
//
//  UIKit shell for `ConSub1View` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ConSub1HostingController: UIViewController {

    let viewModel = ConSub1ViewModel()
    private var hostingController: UIHostingController<ConSub1View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ConSub1View(viewModel: viewModel))
