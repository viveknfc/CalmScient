//
//  ConSub4HostingController.swift
//  Calmscient
//
//  UIKit shell for `ConSub4View` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ConSub4HostingController: UIViewController {

    let viewModel = ConSub4ViewModel()
    private var hostingController: UIHostingController<ConSub4View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ConSub4View(viewModel: viewModel))
