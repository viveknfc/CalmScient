//
//  ConSub3HostingController.swift
//  Calmscient
//
//  UIKit shell for `ConSub3View` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ConSub3HostingController: UIViewController {

    let viewModel = ConSub3ViewModel()
    private var hostingController: UIHostingController<ConSub3View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ConSub3View(viewModel: viewModel))
