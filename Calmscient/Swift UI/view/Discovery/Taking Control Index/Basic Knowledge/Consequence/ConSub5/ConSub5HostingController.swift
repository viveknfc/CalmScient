//
//  ConSub5HostingController.swift
//  Calmscient
//
//  UIKit shell for `ConSub5View` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ConSub5HostingController: UIViewController {

    let viewModel = ConSub5ViewModel()
    private var hostingController: UIHostingController<ConSub5View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ConSub5View(viewModel: viewModel))
