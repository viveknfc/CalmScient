//
//  ConSub2HostingController.swift
//  Calmscient
//
//  UIKit shell for `ConSub2View` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ConSub2HostingController: UIViewController {

    let viewModel = ConSub2ViewModel()
    private var hostingController: UIHostingController<ConSub2View>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ConSub2View(viewModel: viewModel))
