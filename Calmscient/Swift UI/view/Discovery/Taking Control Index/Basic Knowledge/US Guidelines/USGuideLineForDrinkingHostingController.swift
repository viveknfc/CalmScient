//
//  USGuideLineForDrinkingHostingController.swift
//  Calmscient
//
//  UIKit shell for `USGuideLineForDrinkingView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class USGuideLineForDrinkingHostingController: UIViewController {

    let viewModel = USGuideLineForDrinkingViewModel()
    private var hostingController: UIHostingController<USGuideLineForDrinkingView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: USGuideLineForDrinkingView(viewModel: viewModel))
