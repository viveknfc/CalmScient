//
//  BasicStandardDrinkHostingController.swift
//  Calmscient
//
//  UIKit shell for `BasicStandardDrinkView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class BasicStandardDrinkHostingController: UIViewController {

    let viewModel = BasicStandardDrinkViewModel()
    private var hostingController: UIHostingController<BasicStandardDrinkView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: BasicStandardDrinkView(viewModel: viewModel))
