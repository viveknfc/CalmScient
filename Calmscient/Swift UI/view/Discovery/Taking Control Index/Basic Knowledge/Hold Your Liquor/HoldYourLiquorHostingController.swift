//
//  HoldYourLiquorHostingController.swift
//  Calmscient
//
//  UIKit shell for `HoldYourLiquorView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class HoldYourLiquorHostingController: UIViewController {

    let viewModel = HoldYourLiquorViewModel()
    private var hostingController: UIHostingController<HoldYourLiquorView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: HoldYourLiquorView(viewModel: viewModel))
