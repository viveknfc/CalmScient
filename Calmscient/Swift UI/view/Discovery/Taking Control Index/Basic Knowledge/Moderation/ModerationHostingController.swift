//
//  ModerationHostingController.swift
//  Calmscient
//
//  UIKit shell for `ModerationView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class ModerationHostingController: UIViewController {

    let viewModel = ModerationViewModel()
    private var hostingController: UIHostingController<ModerationView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ModerationView(viewModel: viewModel))
