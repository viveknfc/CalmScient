//
//  ModerateDrinkingEducationHostingController.swift
//  Calmscient
//
//  UIKit shell for `ModerateDrinkingEducationView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  25 May 2026
//
...
@available(iOS 16.0, *)
final class ModerateDrinkingEducationHostingController: UIViewController {

    let viewModel = ModerateDrinkingEducationViewModel()
    private var hostingController: UIHostingController<ModerateDrinkingEducationView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: ModerateDrinkingEducationView(viewModel: viewModel))
