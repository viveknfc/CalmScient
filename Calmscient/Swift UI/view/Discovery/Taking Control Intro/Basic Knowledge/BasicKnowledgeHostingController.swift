//
//  BasicKnowledgeHostingController.swift
//  Calmscient
//
//  UIKit shell for `BasicKnowledgeView` (navigation, `NavigationBack`, tab bar).
//
//  Vivek
//  21 May 2026
//
...
@available(iOS 16.0, *)
final class BasicKnowledgeHostingController: UIViewController {

    private let viewModel = BasicKnowledgeViewModel()
    private var hostingController: UIHostingController<BasicKnowledgeView>!
    ...
    override func viewDidLoad() {
        ...
        hostingController = UIHostingController(rootView: BasicKnowledgeView(viewModel: viewModel))
