...
//        @IBOutlet weak var timeLabel: UILabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        normal_text.text = AppHelper.getLocalizeString(str: "DRINKING_CONTROL_Video_Message")
        headerLabel.text = AppHelper.getLocalizeString(str: "DRINKING_CONTROL_Video_Header")
        subHeaderLabel.text = AppHelper.getLocalizeString(str: "DRINKING_CONTROL_Video_Sub_Header")
    }
